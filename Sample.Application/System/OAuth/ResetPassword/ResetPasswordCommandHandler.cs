...
{
    internal class ResetPasswordCommandHandler : CommandHandlerBase<ResetPasswordCommand, UserDto>
    {
        private readonly UserManager<User> _userManager;
        public ResetPasswordCommandHandler(UserManager<User> userManager, IServiceProvider serviceProvider) : base(serviceProvider)
        {
            _userManager = userManager;
        }

        public override async Task<UserDto> CommandHandle(ResetPasswordCommand command, CancellationToken cancellationToken)
        {
